...
pub const CALL_CONTRACT_EVENT_DISC: [u8; 8] = [211, 211, 80, 126, 150, 98, 181, 198]; // sha256(b"event:CallContractEvent")
pub const MESSAGE_APPROVED_EVENT_DISC: [u8; 8] = [232, 125, 221, 19, 212, 213, 137, 199]; // sha256(b"event:MessageApprovedEvent")
pub const MESSAGE_EXECUTED_EVENT_DISC: [u8; 8] = [232, 125, 221, 19, 212, 213, 137, 199]; // sha256(b"event:MessageExecutedEvent")
